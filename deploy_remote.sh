...
echo Je mets la chaine de connexion de ma machine distance dans une variable
MACHINE_DESTINATION="ec2-13-56-228-246.us-west-1.compute.amazonaws.com"
PATH_SECRET_KEY="/secret/kp-afef-2.pem"

sudo chmod 400 $PATH_SECRET_KEY
